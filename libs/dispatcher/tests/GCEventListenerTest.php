...
namespace Local\Dispatcher\Tests;

use Local\Dispatcher\DelegateEventListener;
use Local\Dispatcher\EventListener;
use Local\Dispatcher\Tests\Stub\EventListenerContainerStub;
use PHPUnit\Framework\Attributes\Group;

#[Group('local/dispatcher')]
final class GCEventListenerTest extends TestCase
{
